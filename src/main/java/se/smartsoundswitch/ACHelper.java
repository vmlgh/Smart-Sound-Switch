...
public class ACHelper
{
    ...
    public void updateRingerVolume(Context pContext)
    {
    ...
    public void changeStatusBarColor(Context pContext, Activity pActivity)
    {
        ...
        pWindow.setStatusBarColor(ContextCompat.getColor(pContext, R.color.teal));
    }
