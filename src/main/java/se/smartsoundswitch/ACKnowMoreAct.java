...
public class ACKnowMoreAct extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        pDisplayString += "2. Set the audio preferences accordingly for the selected locations and never get disturbed.\n\n";
        pDisplayString += "3. Don't worry about missing your important calls! :) \n\n 4. If there is a call more than twice within 5 minutes, the settings are disabled and you can hear the ring normally.\n\n";
        pDisplayString += "5. Just swipe right to delete/edit any added location.\n\n";
