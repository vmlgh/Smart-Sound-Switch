...
public class CallReceiver extends PhonecallReceiver
{
    ...
    protected void onIncomingCallReceived(Context ctx, String number, Date date)
    {
        ...
        else
        {
            ...
            i.helper.incomingCallsNumbersList.add(pNumber);
            i.helper.updateRingerVolume(ctx);
        }
    }
    ...
    /*public void setRingerMode(Context context)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
        {
            ...
            i.helper.volumeBar.setMax(audioManager.getStreamMaxVolume(AudioManager.STREAM_RING));
            audioManager.setStreamVolume(AudioManager.STREAM_RING, 10, AudioManager.FLAG_SHOW_UI + AudioManager.FLAG_PLAY_SOUND);
        }
    }*/
